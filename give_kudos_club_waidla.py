...
class KudosGiver:
    ...
    """
    def __init__(self, max_retry_scroll=10, max_run_duration=300) -> None:
    ...
    def email_login(self):
        ...
        print("---Logged in!!---")
        self.page.goto(os.path.join(BASE_URL, "clubs/146243/recent_activity"), wait_until="domcontentloaded")
